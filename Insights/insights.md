...
* Agora é possível ver o crescimento médio por categoria com a função `grafico_media_categoria` passando a categoria e o dataframe pivotado (TODO falta fazer o grágico conjunto pois está separado de um em um e fica muito poluído)
